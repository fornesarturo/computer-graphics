...
var positions;
var shaderProgram;
var aPosition, uModelMatrix, uViewMatrix;
var vboPosition;
var modelMatrix;
var viewMatrix;
...
function renderScene()
{
	...
	// Rotate Camera 30º CW
	var mRcam = mat4.create();
	mat4.rotate(mRcam, mRcam, 30. * Math.PI / 180., [0., 0., 1.]);
	
	mat4.multiply(viewMatrix, mRcam, viewMatrix);
